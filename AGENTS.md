...
Apply all documentation hygiene rules (version bump, AGENTS.md, README.md, delete unused files) in the same commit as the code change.
...
- All changed behaviour is reflected in AGENTS.md and README.md
